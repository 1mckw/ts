...
| 晚觸碰 | AR→上引線、DR→下引線；即時 >10 根 / 晚觸清單 >20 根、10 根內、根數 ≥ 60 |

**趨勢線：** 至少 3 觸點；最多 1 條上升支撐（綠）+ 1 條下降阻力（紅）；須 `valid_to_current`（有效至**最新 K 前 5 根**）；急漲/跌貫穿 grace 2 根 K。另繪 **200D 藍線**：最近 200 根日 K 內觸點最多的線（可已破線）。
